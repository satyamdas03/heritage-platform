export default function ApprenticePage() {
    const apprentices = [
        ...
        { name: 'Amit Pal', age: 21, craft: 'Terracotta', badge: null, goal: 5000, raised: 2250, quote: "Preserving my grandfather's terracotta technique is my life's mission." },
        { name: 'Sana Khan', age: 18, craft: 'Embroidery', badge: null, goal: 5000, raised: 1000, quote: 'I want to bring Kantha stitch to the global fashion stage.' },
    ];
